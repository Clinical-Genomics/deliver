...
setup(
    ...
    description='Data delivery module for data processing and analysis.',
    long_description=parse_readme(),
    # What does your project relate to? Separate with spaces.
    keywords='genomics development',
    author='Robin Andeer',
    author_email='robin.andeer@scilifelab.se',
    license='MIT',

    # The project's main homepage
    url='https://github.com/Clinical-Genomics/data-delivery',
    ...
    entry_points={
        'console_scripts': ['data-delivery = data_delivery.cli:deliver']
    },
